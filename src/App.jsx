  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const completions = await apiClient.createCompletion({
        ...
        prompt: `I am your travelagent, where are you going?: ${prompt} Write this in a way that is inspiring and fun for professional business people with details as in trotter with Hashtags`,
        max_tokens: 880,
        temperature: 0.7,
        top_p: 1,
        frequency_penalty: 0,
